/**
 * AppleIcon Component
 * SVG icon for Apple social login
 */
...
const AppleIcon: React.FC<AppleIconProps> = ({
  ...
  return (
    ...
    >
      ...
      <g clipPath="url(#C)" transform="matrix(.098524 0 0 .098524 89.579758 -18.770519)">
        <use xlinkHref="#B"/>
      </g>
